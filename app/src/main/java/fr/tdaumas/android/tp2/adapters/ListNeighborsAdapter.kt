...
class ListNeighborsAdapter(
    items: List<Neighbor>,
    neighborHandler: ListNeighborHandler
) : RecyclerView.Adapter<ListNeighborsAdapter.ViewHolder>() {
    private val mNeighbours: List<Neighbor> = items
    private val neighborHandler: ListNeighborHandler = neighborHandler
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.mDeleteButton.setOnClickListener {
            neighborHandler.onDeleteNeighbor(neighbour)
        }

        holder.itemView.setOnClickListener {
            neighborHandler.onDetailNeighbor(neighbour)
        }
    }
